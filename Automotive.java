...
public class Automotive implements Serializable {
	...
	public void addOptionSet(String str, int length){
		...
		opsets[nextInsertPosition] = opset;
		nextInsertPosition++;
	}
	...
	//find OptionSet() searches for the required optionSet using optionSet name
	...
	//deleteOptionSet() deletes the required optionset from the option set array
